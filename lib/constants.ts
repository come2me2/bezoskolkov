...
export const SEO = {
  title: "БезОсколков — защита окон от осколков при взрывной волне | Москва и МО",
  description:
    "Защитная противоосколочная плёнка для окон в Москве и Московской области. Удерживает осколки стекла при разрушении окна и взрывной волне. Не защищает от прямого попадания БПЛА. Расчёт стоимости по фото.",
